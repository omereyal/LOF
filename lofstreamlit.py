...
if app_mode == 'About App':
    ...
    with open('aruco.pdf') as pdf_file:
        PDFbyte = pdf_file.encode('latin-1').read()
    st.download_button(label = 'Download a blank page with AruCo marker', data=PDFbyte, file_name = 'aruco.pdf')
